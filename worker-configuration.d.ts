/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 0567ab1e3d58e66aadac8f88daf7b85a)
// Runtime types generated with workerd@1.20260504.1 2025-10-08 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./workers/app");
		durableNamespaces: "BattleRoom" | "GuessRoom" | "FakeArtistRoom" | "SquiggleRoom" | "DoodleRoom" | "GameStats" | "GalaxySwarmRoom" | "HighScores" | "BugBlasterRoom" | "GalagaRoom";
	}
	interface Env {
		ART_BUCKET: R2Bucket;
		...
		GUESS_ROOM: DurableObjectNamespace<import("./workers/app").GuessRoom>;
		FAKE_ROOM: DurableObjectNamespace<import("./workers/app").FakeArtistRoom>;
		SQUIGGLE_ROOM: DurableObjectNamespace<import("./workers/app").SquiggleRoom>;
		DOODLE_ROOM: DurableObjectNamespace<import("./workers/app").DoodleRoom>;
		GAME_STATS: DurableObjectNamespace<import("./workers/app").GameStats>;
		GALAXY_ROOM: DurableObjectNamespace<import("./workers/app").GalaxySwarmRoom>;
		HIGH_SCORES: DurableObjectNamespace<import("./workers/app").HighScores>;
		BLASTER_ROOM: DurableObjectNamespace<import("./workers/app").BugBlasterRoom>;
		GALAGA_ROOM: DurableObjectNamespace<import("./workers/app").GalagaRoom>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "VALUE_FROM_CLOUDFLARE" | "ADMIN_PASSWORD" | "CLOUDFLARE_API_TOKEN">> {}
}
