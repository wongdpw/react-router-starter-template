...
// from /public/dig-dug-game.html. Embedding it in an iframe keeps its own
// code untouched while this route supplies the site header and the shared
// arcade high-score board.
export default function DigDug({}: Route.ComponentProps) {
	const { board, pendingScore, justRanked, finishRun, submit, dismiss } = useHighScores("dig-dug");
	...
	useEffect(() => {
		function onMessage(event: MessageEvent) {
			...
			if (!data || data.type !== "arcade:gameover" || data.game !== "dig-dug") return;
	...
	return (
		<div style={{ fontFamily: "'Inter', sans-serif", background: COLORS.bg, color: COLORS.text, minHeight: "100vh" }}>
			...
			>
				<h1 style={{ fontFamily: "'Archivo Black', sans-serif", fontSize: 32, margin: "0 0 8px" }}>Dig Dug</h1>
